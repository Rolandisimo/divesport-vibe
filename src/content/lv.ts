...
const lv: SiteContent = {
  ...
  home: {
    ...
    quickPaths: [
      { icon: '🎓', title: 'Apmācība', description: 'Kursi visiem līmeņiem — no pirmās ieniršanas līdz instruktoram', slug: 'apmaciba-kursi' },
      { icon: '✈️', title: 'Ceļojumi', description: 'Niršanas ceļojumi visā pasaulē', slug: 'celojumi' },
      { icon: '🛠️', title: 'Inventārs', description: 'Noma, pārdošana, remonts un balonu uzpilde', slug: 'inventars' },
    ],
