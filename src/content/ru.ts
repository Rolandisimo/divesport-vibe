...
const ru: SiteContent = {
  ...
  celojumiHub: {
    ...
    heroLede: 'В этом разделе вы можете ознакомиться с запланированными поездками, которые организует наш клуб.',
    paragraphs: [
      'Организуем дайвинг-поездки и связанные с дайвингом мероприятия по всему миру. Мы не останавливаемся на самых известных местах.',
      'Актуальные направления и даты меняются в зависимости от сезона — свяжитесь с нами, чтобы узнать, что запланировано.',
    ],
    ctaPrimary: 'Узнать о ближайших поездках',
