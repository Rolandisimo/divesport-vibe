...
const ru: SiteContent = {
  ...
  footer: { copyright: 'Divesport. Все права защищены.' },
  ...
  home: {
    ...
    quickPaths: [
      { icon: '🎓', title: 'Обучение', description: 'Курсы для всех уровней — от первого погружения до инструктора', slug: 'apmaciba-kursi' },
      { icon: '✈️', title: 'Путешествия', description: 'Дайвинг-путешествия по всему миру', slug: 'celojumi' },
      { icon: '🛠️', title: 'Инвентарь', description: 'Аренда, продажа, ремонт и заправка баллонов', slug: 'inventars' },
    ],
